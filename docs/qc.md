...
wget https://biocorecrg.github.io/PhD_course_genomics_format_2022/data/H3K4me1_chr21_fastqc.html
...
```{bash}
 https://biocorecrg.github.io/PhD_course_genomics_format_2022/data/H3K4me1_chr21_fastqc.html
```
