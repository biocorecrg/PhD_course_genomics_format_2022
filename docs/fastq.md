...
```{bash}
mkdir 2021-10-18-genomics_data_formats

# type cd 2[TAB] to autofill the folder name
cd 2021-10-18-genomics_data_formats
```
...
```{bash}
wget https://biocorecrg.github.io/PhD_course_genomics_format_2021/data/H3K4me1_chr21.fq.gz 
...
**EXERCISE**<br/>
* Download the **control file for this ChIP-seq experiment** at https://biocorecrg.github.io/PhD_course_genomics_format_2021/data/input_chr21.fq.gz <br/>
